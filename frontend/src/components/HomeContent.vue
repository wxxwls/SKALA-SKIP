<template>
  ...
  >
    <!-- Main Content Area -->
    <div class="flex-1 overflow-y-auto" :style="{ padding: '24px 24px 24px 40px' }">
      <!-- Top - RE100 달성현황 (3 boxes) -->
      <div :style="{ marginBottom: '24px' }">
        <h2 :style="{ fontSize: '18px', fontWeight: 600, color: '#1A1F2E', marginBottom: '16px' }">
          국내외 RE100 달성현황
        </h2>
...
:style="{
            ...
            <div :style="{ fontSize: '36px', fontWeight: 700, marginBottom: '8px', color: '#FF8F68' }">
              68%
            </div>
            <div class="flex items-center gap-1" :style="{ fontSize: '12px', color: '#10B981' }">
              <TrendingUp :size="16" />
              <span>+12% 전년 대비</span>
            </div>
          </div>
...
:style="{
            ...
            <div :style="{ fontSize: '36px', fontWeight: 700, marginBottom: '8px', color: '#3B82F6' }">
              82%
            </div>
            <div class="flex items-center gap-1" :style="{ fontSize: '12px', color: '#10B981' }">
              <TrendingUp :size="16" />
...
:style="{
            ...
            <div :style="{ fontSize: '36px', fontWeight: 700, marginBottom: '8px', color: '#10B981' }">
              76%
            </div>
            <div class="flex items-center gap-1" :style="{ fontSize: '12px', color: '#10B981' }">
              <TrendingUp :size="16" />
